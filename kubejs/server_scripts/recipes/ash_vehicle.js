...
ServerEvents.recipes(event => {
    ...
    event.custom({
        ...
        inputs: [
            ...
            "12 minecraft:gold_ingot",
            "32 minecraft:iron_ingot"
        ],
        result: {
    ...
    event.custom({
        ...
        inputs: [
            ...
            "2 ashvehicle:enginefanitem",
            "30 mcore:titanium_sheet",
            "34 minecraft:gold_ingot",
            "46 minecraft:iron_ingot"
        ],
        result: {
    ...
    event.custom({
        ...
        result: {
            "entity": "superbwarfare:wavedefense"
        }
    });
